Silicon Image SiI 3114 SATARaid Controller OS Driver Installation
-------------------------------------------------------------------------
...
SiI 3114 driver on a system already running Windows NT 4.0.
...
7. Insert the diskette labeled ' Silicon Image SiI 3114 SATARaid
   Driver Installation Disk' into A: and press 'Enter'.

8. Choose 'Silicon Image SiI 3114 SATARaid Controller' and 
   click 'OK'.
...
---------------------------------------------------------------------------
Follow the instructions in this section to install the Silicon Image
SiI 3114 driver on a system already running Windows 2000.
...
5.  Insert the diskette labeled ' Silicon Image SiI 3114 SATARaid Driver
...
installed correctly.
   ...
   For Windows 2000/XP
      ...
      2. Double click on 'SCSI and RAID Controllers', If there is no
         ...
         'Silicon Image SiI 3114 SATARaid Controller', the driver
   ...
   For Windows NT 4.0
      ...
      1. Double click on 'My Computer' icon, select 'Control Panel', click
         on 'SCSI Adapters' icon, 'Silicon Image SiI 3114 SATARaid 
...
6. Insert the diskette labeled 'Silicon Image SiI 3114 SATARaid Driver
   Installation Disk' into A: and press 'Enter'.

7. Choose 'Silicon Image SiI 3114 SATARaid Controller' and 
   click 'OK'.
...
Silicon Image SiI 3114 controller card, you need to run the update program 
