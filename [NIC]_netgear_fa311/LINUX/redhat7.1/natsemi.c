				     ...
				     const struct pci_device_id *ent)
{
	...
	/* Enable power on the Netgear FA31x */
	pci_read_config_byte(pdev, 0x45, &powerstate);
	powerstate &= ~3; /* set powerstate to D0 */
	pci_write_config_byte(pdev, 0x45, powerstate);
